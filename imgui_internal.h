...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const char* label, const char* icon, const char* ksub, bool selected);
    ...
    IMGUI_API bool          Search(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data);
